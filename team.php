...
<head>
	<meta charset="UTF-8">
	<title>SolarSand - Наша Команда</title>
...
<div class="content">
	<h1> Наша Команда</h1>
			...
			<p><r style="color: red;">Vlad_Igronavt</r> - Технический Администратор</p>
			<p><r style="color: red;">Mafredin_Jinoda</r> - Игровой Администратор</p>
			
					<p><r style="color: #9f209f;">JasterLkr</r> - Спонсор</p>
			<div class="row">
				<div class="col-lg-4">
			<h2>HiTech</h2>
			<p><y style="color: yellow;">Raskai</y> - Главный модератор</p>
			<p><y style="color: yellow;">KrestoV</y> - Модератор</p>
			<p><g style="color: green;">Desu</g> - Хелпер</p>
				</div>
				<div class="col-lg-4">
			<h2></h2>
				</div>
