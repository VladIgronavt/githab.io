...
<head>
	<meta charset="UTF-8">
	<title>SolarSand - Игровые сервера MineCraft</title>
...
<?php else : ?>
	...
	<div class="container-fluid">
		...
		<h1>SolarSand</h1>
		<p>Игровые сервера MineCraft</p>
		<a class="button" href="/start.php">Начать игру</a>
	</div>
</div>
	</div>
	</div>
...
foreach ($news as $row){
echo '<div class="block style="margin-top: 20px;">' . '<p>' . $row['title'] .'</p>'.'<br>' . '<h2>' . $row['news'] . '</h2>' . '<br>' . '<h3>' . $row['date'] . '</h3>' . '<br>' . '</div>';
}
	?>
	 w
	</section>
